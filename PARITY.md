...
| collab-02 | Threads/tasks | Fork, resume, archive, delete, pin, rename, handoff metadata | `src/state.rs`, `src/protocol.rs`, `src/ui.rs` | implemented | G2/G4/G8: live thread lifecycle adapter plus native task creation, archive, unarchive, resume, delete, and rename paths; fork/handoff coverage remains incomplete |
